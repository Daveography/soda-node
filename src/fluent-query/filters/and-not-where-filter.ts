...
export class AndNotWhereFilter<TEntity, TValue> implements IWhereFilter<TEntity, TValue> {
  ...
  public equals(value: TValue): IFilteredQueryable<TEntity> {
    ...
    return this.query.addFilter(new WhereOperator(Operator.And), new WhereOperator(Operator.Not), filter);
  }
