...
describe("WellKnownType", () => {
  ...
  it("should create WKT for point", () => {
    ...
    expect(wkt.toString())
      .toEqual("POINT (-68.980986 12.198599)");
  });
  ...
  it("should create WKT for polygon", () => {
    ...
    expect(wkt.toString())
      .toEqual("POLYGON ((-113.599831726514 53.458273089013, -113.600049996812 53.45827360864, -113.600052949158 53.457932503403, -113.599845224387 53.457931995732, -113.599834691275 53.457931970341, -113.599831726514 53.458273089013))");
  });
